...
<script type="text/javascript" src="{{ secure_asset('assets/js/brokebot.js') }}"/></script>
<script src="{{ secure_asset('assets/js/snap.svg-min.js') }}" type="text/javascript"></script>
