        ...
        <div class="be-wrapper be-nosidebar-left">
            <nav class="navbar navbar-default navbar-fixed-top be-top-header">
                <div class="container-fluid">
                    ...
                    <a href="#" data-toggle="collapse" data-target="#be-navbar-collapse" class="be-toggle-top-header-menu collapsed">Wihout Sidebars</a>
                    <div id="be-navbar-collapse" class="navbar-collapse collapse">
                        <ul class="nav navbar-nav">
                            <li><a href="index.html">Home</a></li>
                            <li><a href="ui-general.html">UI Elements</a></li>
                            <li class="dropdown">
                                <a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="dropdown-toggle">Forms <span class="mdi mdi-caret-down"></span></a>
                                <ul role="menu" class="dropdown-menu">
                            ...
                            <li><a href="tables-general.html">Tables</a></li>
                        </ul>
                    </div>
                </div>
            </nav>
            <div class="be-content">
                <div class="page-head">
                    <h2 class="page-head-title">Without sidebars</h2>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-md-6 col-md-offset-3">
                            <div class="panel panel-default">
                                <div class="panel-heading"><span class="title">Remove both sidebars</span></div>
                                <div class="panel-body">
                                    <p>Like the previous examples you can remove <b>Both Sidebars</b> elements directly from the html structure (<code>be-left-sidebar</code> and <code>be-right-sidebar</code>), additionaly you must to add the class <code>be-nosidebar-left</code> into the main wapper element.</p>
                                </div>
